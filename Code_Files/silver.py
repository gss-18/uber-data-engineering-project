...
# Flow 3 — Persistent Archive (survives EventHub delete/recreate)
@dp.append_flow(target="uber.silver.stg_rides")
def rides_archive():
    df = spark.readStream.table("uber.bronze.streaming_rides_archive")
    return df